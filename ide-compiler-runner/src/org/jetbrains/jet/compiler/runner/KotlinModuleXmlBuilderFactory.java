...
public class KotlinModuleXmlBuilderFactory implements KotlinModuleDescriptionBuilderFactory {
    ...
    private static class Builder implements KotlinModuleDescriptionBuilder {
        ...
        public KotlinModuleDescriptionBuilder addModule(
                ...
                List<? extends File> sourceFiles,
                boolean tests,
                final Set<? extends File> directoriesToFilterOut
        ) {
            ...
            dependencyProvider.processClassPath(new DependencyProcessor() {
                @Override
                public void processClassPathSection(@NotNull String sectionDescription, @NotNull Collection<? extends File> files) {
                ...
                @Override
                public void processAnnotationRoots(@NotNull List<? extends File> files) {
