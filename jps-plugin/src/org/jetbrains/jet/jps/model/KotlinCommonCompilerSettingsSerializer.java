...
import static org.jetbrains.jet.plugin.compiler.SettingConstants.KOTLIN_COMMON_COMPILER_SETTINGS_SECTION;
import static org.jetbrains.jet.plugin.compiler.SettingConstants.KOTLIN_COMPILER_SETTINGS_FILE;
...
class KotlinCommonCompilerSettingsSerializer extends JpsProjectExtensionSerializer {
    ...
    public void loadExtension(@NotNull JpsProject project, @NotNull Element componentTag) {
        CommonCompilerArguments settings = XmlSerializer.deserialize(componentTag, K2JVMCompilerArguments.class);
        if (settings == null) {
